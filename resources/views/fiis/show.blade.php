...
@section('content')
    ...
    <div class="mt-2 bg-neutral-100 w-2/3 mx-auto rounded-lg shadow-[0_5px_9px_-4px_#3b71ca]">
        ...
        <form method="post" action="{{ route('fiis.update') }}">
            @csrf
            ...
            <div class="w-full p-2">
                <div class="flex items-center">
                    ...
                    <input class="flex-auto rounded-md" type="text" class="" name="tipo" id="tipo" value="{{ $fii->tipo->nome }}"/>
                </div>
            </div>
            ...
            <div class="w-full p-2">
                <div class="flex items-center">
                    ...
                    <input class="flex-auto rounded-md" type="text" class="" name="segmento" id="segmento" value="{{ $fii->segmento->nome }}"/>
                </div>
            </div>
            ...
            <div class="w-full p-2">
                <div class="flex items-center">
                    ...
                    <textarea class="flex-auto rounded-md" type="text" class="" name="descricao" id="descricao">{{ $fii->descricao }}
                    </textarea>
                </div>
            </div>
            ...
            <div class="w-full p-2">
                <div class="flex items-center">
                    ...
                    <textarea class="flex-auto rounded-md" type="text" class="" name="caracteristicas" id="caracteristicas">{{ $fii->caracteristicas }}
                    </textarea>
                </div>
            </div>
