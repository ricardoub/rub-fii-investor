...
@section('content')
    ...
    <div class="mt-2 bg-neutral-100 w-3/4 mx-auto rounded-lg shadow-[0_5px_9px_-4px_#3b71ca]">
        ...
        <form x-data method="post" action="{{ route('rendimentos.update', $rendimento->id) }}">
            @csrf
            ...
            <div class="p-3 items-center">
                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="grid grid-cols-10 gap-1 items-center">
                        <input x-mask="99/99/9999" class="col-span-8 text-right rounded-md" type="text" name="data_com" id="data_com" value="{{ old('data_com', old('data_com', $rendimento->data_com)) }}"/>
                        <span class="col-span-2 text-left text-gray-500"></span></div>
