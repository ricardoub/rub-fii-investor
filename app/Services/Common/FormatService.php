...
class FormatService
{
    ...
    public function x_formatData_toBR_fromEN($dtRecebida)
    {
        if ($dtRecebida) {
    ...
    public function x_formatData_toEN_fromBR($dtRecebida)
    {
        if ($dtRecebida) {
    ...
    public function x_formatNumber_toBR_fromEN($vlrRecebido, $qtdeDecimais)
    {
    ...
    public function x_formatNumber_toEN_fromBR($vlrRecebido, $qtdeDecimais)
    {
        if ($vlrRecebido && $qtdeDecimais) {
            $numero = str_replace(",", '.', $vlrRecebido);
